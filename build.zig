...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "libWallpaper" is the name you will use in your source code to
                // import this module (e.g. `@import("libWallpaper")`). The name is
    ...
    // Link Windows C++ code for module tests if targeting Windows
    if (is_windows) {
        mod_tests.addCSourceFile(.{
            .file = b.path("src/platform/windows/lib_win.cpp"),
            .flags = &.{"-std=c++17"},
        });
        mod_tests.linkSystemLibrary("ole32");
        mod_tests.linkSystemLibrary("shlwapi");
    ...
    // Link Windows C++ code for executable tests if targeting Windows
    if (is_windows) {
